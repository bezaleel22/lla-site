...
<head>
    ...
    <title>News aAlert | Lighthouse Leading Academy</title>
...
<input type="hidden"  name="groupid" value="<?php echo uniqid();?>">
                                       <div class="col-12-xxxl col-lg-12 col-12 form-group">
                                            <label>Attach Image (Best Dimension 387x250)</label>
                                         ...
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="delete_blog.php?groupid=<?php echo $row['groupid'];?>"><i class="fas fa-times text-orange-red"></i>Delete</a>
