...
<?php if(!empty($statusMsg)){ ?>
        ...
        <?php } ?>
               ...
               <input type="hidden"  name="title" value="<?php echo 'sliders';?>">                        
                                        
<input type="hidden"  name="groupid" value="<?php echo uniqid();?>">
                                       <div class="col-12-xxxl col-lg-12 col-12 form-group">
                                            <label>Slide Image (Dimension 3365x2244)</label>
...
<?php// echo $_POST['groupid'];?>
                                         ...
                                         <div class="col-12 form-group">
                                            <label>Slides Description</label>
                ...
                <?php include 'dbConfig.php';
                    $query = $db->query("SELECT * FROM images where category='2' GROUP BY groupid ORDER BY uploaded_on DESC");
                    if($query->num_rows > 0){
                                         ...
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="delete_slide.php?groupid=<?php echo $row['groupid'];?>"><i class="fas fa-times text-orange-red"></i>Delete</a>
