...
<head>
<title>Contact us - Light House Academy</title>
<meta charset="UTF-8">
...
<i class="twi-pen2"></i>
<textarea class="required" name="con_message" placeholder="Type Your Message"></textarea>
</div>
...
<div class="input-field col-md-12">
<button type="submit" class="qu_btn">Submit Now</button>
