...
<head>
<title>BloG Post - Light House Leading Academy</title>
<meta charset="UTF-8">
...
<a class="rm_more" href="view_blog.php?groupid=<?php echo safe_encode($row['groupid']);?>">Read More <?php //echo  $row['file_name'];?></a>
</div>
</div>
</div>
