  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <div class="navbar01">
          <div class="logo">
            <a href="index.php"><img src="assets/images/logo2.png" alt="Quera"></a>
          </div>
          <nav class="mainMenu">
            <ul>
          ...
          <div class="navleft">
            <div class="icon_box_04">
              <div class="ib_box">
                <svg xmlns="http://www.w3.org/2000/svg" style="height:48;width: 48;" fill="currentColor" viewBox="0 0 24 24">
  ...
  <section class="sidebarMenu">
    ...
    <div class="SMArea">
      ...
      <div class="SMABody">
        ...
        <a href="https://llacademy.ng/parent-dashboard" target="_blank" class="qu_btn mx-auto">Student Portal</a>
      </div>
    </div>
